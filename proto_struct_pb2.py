...
sens_dat = _reflection.GeneratedProtocolMessageType('sens_dat', (_message.Message,), {
  'DESCRIPTOR' : _SENS_DAT,
  '__module__' : 'proto_struct_pb2'
